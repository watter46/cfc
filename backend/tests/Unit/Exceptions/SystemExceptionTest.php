...
class SystemExceptionTest extends TestCase
{
    ...
    {
        $this->assertTrue(is_subclass_of(SystemException::class, \App\Exceptions\UserFriendlyException::class));
    }
    ...
    {
        $reflection = new ReflectionClass(SystemException::class);
        ...
        $this->assertSame(500, $parameters[0]->getDefaultValue());
    }
    ...
    public function test_class_metadata(): void
    {
        ...
        $this->assertSame('SystemException', $reflection->getShortName());
    ...
    {
        $this->assertTrue(is_subclass_of(SystemException::class, Exception::class));
    }
}
